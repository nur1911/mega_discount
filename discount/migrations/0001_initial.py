    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditions_take', models.TextField(verbose_name='Для получения скидки:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rull', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='discount.rull')),
            ],
        ),
        migrations.AddField(
            model_name='company',
        ...
        migrations.AddField(
            model_name='company',
            name='phone',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='discount.phone'),
        ),
        migrations.AddField(
            model_name='company',
            name='reviews',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='discount.review'),
        ),
        migrations.AddField(
            model_name='company',
            name='views',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='discount.view'),
        ),
        migrations.CreateModel(
            name='ClientDiscount',
            fields=[
